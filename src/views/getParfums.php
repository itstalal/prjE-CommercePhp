...
$stmt->execute(['categoryName' => 'Parfums']);
...
<div class="bg-gray-100" style="margin-top: 100px;">
    <div class="container mx-auto p-4">
        <h1 class="text-3xl font-bold text-center mb-8">Produits - Parfums</h1>
        ...
        <div class="flex justify-start mb-8">
            ...
            >
                <option value="?order=default" <?= !isset($_GET['order']) || $_GET['order'] == 'default' ? 'selected' : '' ?>>Trier par prix</option>
